...
function printStyle() {
	...
	res += '  .thang {padding:1;table-layout:fixed}\n';
...
function printTable(mm, yy) {
	...
	var res = "";
	res += ('<table class="thang" border="2" cellpadding="1" cellspacing="1" width="80%">\n');
	res += printHead(mm, yy);
	for (i = 0; i < 6; i++) {
		res += ("<tr>\n");
		for (j = 0; j < 7; j++) {
...
function getPrevMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'">	<span class="glyphicon glyphicon-chevron-left"></span></a>';
}
...
function getNextMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'">	<span class="glyphicon glyphicon-chevron-right"></span></a>';
}

function getPrevYearLink(mm, yy) {
	//return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><img src="left2.gif" width=16 height=12 alt="PrevYear" border=0></a>';
	return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><span class="glyphicon glyphicon-backward"></span></a>';
}

function getNextYearLink(mm, yy) {
	//return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><img src="right2.gif" width=16 height=12 alt="NextYear" border=0></a>';
	return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><span class="glyphicon glyphicon-forward"></span></a>';
}
